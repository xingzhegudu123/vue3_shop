...
export default {
    ...
    mounted() {
        // 参考: https://www.cnblogs.com/web-cuicui/p/12629079.html
...
　　},
    ...
    async getParentCateList() {
      const { data: res } = await this.$http.get('categories', { // 因为分类只有三级  所以新数据最多只能加到二级下
        params: { type: 2 }
      })
      ...
      console.log('父级分类的数据列表', res.data)
